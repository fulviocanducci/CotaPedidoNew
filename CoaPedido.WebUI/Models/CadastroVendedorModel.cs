...
{
    public class CadastroVendedorModel
    {
        ...
        [Display(Name = "Endereço")]
        [MaxLength(120, ErrorMessage = "O campo Endereço de cobrança deve conter no máximo 120 caracteres")]
        ...
        public void GetVendedorModel(Vendedor vendedor)
        {
            Id = vendedor.Id;
            Bairro = vendedor.Bairro;
            BairroCobranca = vendedor.BairroCobranca;
            Celular = vendedor.Celular;
            CelularCobranca = vendedor.CelularCobranca;
            CEP = vendedor.CEP;
            CEPCobranca = vendedor.CEPCobranca;
            CNPJ = vendedor.CNPJ;
            RG = vendedor.RG;
            Complemento = vendedor.Complemento;
            ComplementoCobranca = vendedor.ComplementoCobranca;
            Endereco = vendedor.Endereco;
            EnderecoCobranca = vendedor.EnderecoCobranca;
            IdCidade = vendedor.IdCidade;
            IdCidadeCobranca = vendedor.IdCidadeCobranca;
            IE = vendedor.IE;
            IM = vendedor.IM;
            NomeCompleto = vendedor.RazaoSocial;
            PrimeiroNome = vendedor.NomeFantasia;
            Numero = vendedor.Numero;
            NumeroCobranca = vendedor.NumeroCobranca;
            Site = vendedor.Site;
            Telefone = vendedor.Telefone;
            TelefoneCobranca = vendedor.TelefoneCobranca;
